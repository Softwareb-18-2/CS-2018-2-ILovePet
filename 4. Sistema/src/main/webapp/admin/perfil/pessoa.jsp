          ...
          <div class="col-md-4">
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"><btn class="btn btn-sm btn-outline-success btn-round btn-icon"><i class="fa fa-plus"></i></btn> Meus Pets</h4>
              </div>
              <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-7 col-7">
                        ...
                        <span class="text-muted">
                          <i class="fa fa-venus" style="color:crimson;"></i> | <small>Idade: 2 anos</small>
                        </span>
                      </div>
                ...
                <form>
                  <div class="row">
                    <div class="col-md-5">
                      <div class="form-group">
                        <label>Usuário</label>
                        <input type="text" class="form-control" disabled="" placeholder="Usuário" value="chetfaker">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email</label>
                        <input type="email" class="form-control" placeholder="E-mail" value="email@gmail.com">
                      </div>
                    </div>
                  </div>
                  <div class="row">
					<div class="col-md-6">
                      <div class="form-group">
                        <label>Nome</label>
                        <input type="text" class="form-control" placeholder="Nome" value="Chet Faker">
                      </div>
                    </div>                  
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>Telefone</label>
                        <input type="tel" class="form-control" placeholder="+55 (62) 1234-5678" value="+55 (62) 1234-5678">
                      </div>
                    </div>
	                <div class="col-md-3">
	                  <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        <label>Cidade</label>
                        <input type="text" class="form-control" placeholder="Cidade" value="Goiânia">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label>País</label>
                        <input type="text" class="form-control" placeholder="País" value="Brasil">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label>CEP</label>
                        <input type="number" class="form-control" placeholder="7412345" value="7412345">
                      </div>
                    </div>
                  </div>
                  <div class="row">
