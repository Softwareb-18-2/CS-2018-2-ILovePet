...
<head>
	<title>iLovePet - Cadastrar</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('assets/images/pet2.jpg');">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-15 p-b-10">
				<form class="login100-form validate-form flex-sb flex-w" action="/ilovepet/Perfil">
					<a class="login100-form-title p-b-53" href="/ilovepet">
					...
					<div class="wrap-input100 validate-input" data-validate="Confirmação de Senha obrigatório!">
						<input class="input100" type="password" id="confimaSenha" name="confimaSenha">
						<span class="focus-input100"></span>
					</div>
					
					
					<div class="p-t-80 p-b-9">
						<span class="txt1">
							Nome
						</span>
					</div>
